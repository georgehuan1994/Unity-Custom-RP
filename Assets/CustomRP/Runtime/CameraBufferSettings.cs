...
public struct CameraBufferSettings
{
    ...
    public struct FXAA
    {
        ...
        // 对比度绝对阈值，Trims the algorithm from processing darks.
        //   0.0833 - upper limit (default, the start of visible unfiltered edges)
        //   0.0625 - high quality (faster)
        //   0.0312 - visible limit (slower)
        [Range(0.0312f, 0.0833f)] public float fixedThreshold;

        // 对比度相对阈值，The minimum amount of local contrast required to apply algorithm.
        ...
        // 混合强度，Choose the amount of sub-pixel aliasing removal.
